...
var tuyeeTable = function (originProps) {
    var toolBarRender = originProps.toolBarRender, cudProps = originProps.cudProps, headerTitle = originProps.headerTitle, columns = originProps.columns;
    ...
    useEffect(function () {
        ...
        var isNeedToolBar = ((cudProps === null || cudProps === void 0 ? void 0 : cudProps.post) !== undefined) || (toolBarRender !== undefined) || (headerTitle !== undefined);
        if (!isNeedToolBar) {
            ...
            tableProps.toolBarRender = function (action, row) {
                ...
                if (cudProps && cudProps.post) {
                    ...
                    add = [React.createElement(TheAdd, null)];
                }
        ...
        if (cudProps && cudProps.update) {
            ...
            if (type === "line") {
                tableProps.editable = {
                    type: 'single',
                    actionRender: function (row, config, dom) { return [dom.save, dom.cancel]; },
                    ...
                    onSave: function (key, changes) {
                        ...
                        if (isPatch_1) {
                            if (isPatch_1 !== true && isPatch_1.addKey)
                                data = utils_1.default.getChangesParams(changes, editRows[0], { key: tableProps.rowKey });
                            else
        ...
        if (columns) {
            ...
            if (originOptions_1.length > 0 || (cudProps && cudProps.update) || (cudProps && cudProps.delete)) {
