...
var myUtils = {
    ...
    deleteTrigger: function (props, row, action) { return function (baseProps) {
        var content = props.content, onFinish = props.onFinish, triggerText = props.triggerText;
        var ask = function () {
            confirm({
                title: '移除提醒',
                ...
                okType: 'danger',
                cancelText: '取消',
                onOk: function () { return onFinish(row, action); },
                onCancel: function () { }
            });
        };
    ...
    updateTrigger: function (props, theRowKeyValue, action, columns, editRow, theRowKey) { return function (baseProps) {
        var type = props.type, isPatch = props.isPatch, onFinish = props.onFinish, triggerText = props.triggerText;
            ...
            return React.createElement(pro_form_1.BetaSchemaForm, { initialValues: editRow, trigger: React.createElement("a", null, theTriggerText), layoutType: "DrawerForm", onFinish: function (values) {
                    ...
                    if (isPatch) {
                        if (isPatch !== true && isPatch.addKey)
                            result = myUtils.getChangesParams(originData, editRow, { key: theRowKey !== null && theRowKey !== void 0 ? theRowKey : "id" });
                        else
